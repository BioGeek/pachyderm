...
type getObjDirectFunc func(*pfs.GetObjRequest, pfs.ObjectAPI_GetObjDirectServer) error
...
func (mock *mockPutObj) Use(cb putObjDirectFunc)           { mock.handler = cb }
func (mock *mockGetObj) Use(cb getObjDirectFunc)           { mock.handler = cb }
